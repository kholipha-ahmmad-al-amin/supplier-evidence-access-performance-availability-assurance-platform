...
export const createApp = (service) => {
  ...
  app.post('/access-performance-availability-reviews', (request, response, next) => {
    try {
  ...
  app.get('/access-performance-availability-reviews/:id', (request, response, next) => {
    try {
  ...
  app.post('/access-performance-availability-reviews/:id/:action', (request, response, next) => {
    try {
